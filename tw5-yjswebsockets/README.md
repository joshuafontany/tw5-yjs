...
file. For the moment this plugin must be located in the `joshuafontany/tw5-yjs`
subfolder of your plugins folder and listed as `joshuafontany/tw5-yjs` in the
...
git clone --depth=1 https://github.com/OokTech/TW5-Yjs.git TiddlyWiki5/plugins/joshuafontany/tw5-yjs
mkdir TiddlyWiki5/Wikis
cp -r TiddlyWiki5/plugins/joshuafontany/tw5-yjs/RootWiki TiddlyWiki5/editions/RootWiki/
```
...
```
cd TiddlyWiki5
node ./tiddlywiki.js editions/RootWiki  --wsserver
```
...
`editions/RootWiki/tiddlers` folder, any edits you do to those files
...
tiddlywiki editions/RootWiki  --wsserver
```
...
```
cd TiddlyWiki5
cd plugins/joshuafontany/tw5-yjs
git pull
```
